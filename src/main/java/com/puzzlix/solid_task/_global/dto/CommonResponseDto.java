...
//    }
//     대체됨 - @AllArgsConstructor(access = AccessLevel.PRIVATE)

    // 정적 팩토리 메서드 (팩토리 패턴과 다른 개념)
    // static 객체는 속성이 아니라, 클래스에 포함 - ClassName.add()
     ...
     */
    // 그래서 new CommonResponseDto() 이게 되지 않고
    // CommonResponseDto.error("잘못된 비번입니다"); <- 이렇게 해야한다
